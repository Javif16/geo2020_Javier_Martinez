...
def filter_dates_by_quality(grouped_files, max_cloud_percentage=12, max_bad_percentage=10):
    """
    ...
    for date_str in filtered_dates:
        ...
        if match:
            ...
            # Format and print
            formatted = date_obj.strftime("%d/%m/%Y - %H:%M:%S")
            print(f"  {formatted}")
